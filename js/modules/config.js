...
export const CONFIG = {
  // API Configuration
  GROQ_API_KEY: 'REEMPLAZA_CON_TU_API_KEY', // Get it from groq.com → API Keys
...
export const MESSAGES = {
  ...
  WELCOME: '¡Hola! Soy el asistente técnico de la <strong>IPUC Central Cali</strong>. 👋<br><br>Puedo ayudarte con <strong>Luces</strong>, <strong>Transmisión</strong> y <strong>Proyección</strong>. Cuéntame qué está pasando.',
};
